...
export default function Login() {
  ...
  const [form, setForm] = useState({ email: 'admin@dineway.com', password: 'admin123' });
  ...
  return (
    <main className="login-page">
      <section className="login-photo">
        <Logo />
        <img src="https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?auto=format&fit=crop&w=900&q=80" alt="Restaurant table" />
      </section>
      <section className="login-panel">
        <form className="login-card" onSubmit={submit}>
          <h1>WELCOME BACK</h1>
          <h2>Login to <span>DINEWAY</span></h2>
